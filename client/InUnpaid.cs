...
namespace kaikei0_c
{
    public partial class InUnpaid : Form
    {
        private const string m_meg1 = NetMeg.INSORT;
        private const string m_meg2 = NetMeg.REQ_UNPAYD;
        ...
        private void InUnpaid_Load(object sender, EventArgs e)
        {
        ...
        {
            //未入力の項目がある
            if (IsntInt(textBox1.Text) || IsntInt(textBox2.Text))
            {
            ...
            Cnet.Send("INSERT_PAID(" + textBox1.Text + "," + textBox2.Text + ")");
