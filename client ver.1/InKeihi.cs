...
namespace kaikei0_c
{
    public partial class InKeihi : Form
    {
        private const string m_meg1 = NetMeg.INSORT;
        private const string m_meg2 = NetMeg.REQ_KEIHI;
        ...
        private void InKeihi_Load(object sender, EventArgs e)
        {
        ...
        {
            //未入力の項目がある
            if (IsntDate(textBox1.Text) || IsntInt(textBox2.Text)|| IsntInt(textBox3.Text))
            {
            ...
            Cnet.Send("INSERT_KEIHI(" + textBox1.Text + "," + textBox2.Text + "," + textBox3.Text + ")");
